...
- `PolishEquity.Analytics.Schemas/` - Data Contracts: Shared Class Library containing strictly typed input/output models used across the entire solution. see [DataContract](Polish-Equity-Analytics-.NET-LightGBM-Predictor/PolishEquity.Analytics.Schemas/Schemas
/Schemas.cs)
